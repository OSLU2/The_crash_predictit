...
$consulta = "SELECT * FROM acci_usu WHERE id = $idreg";

$resultado = mysqli_query($conexion, $consulta);

$resultado_row = mysqli_num_rows($resultado);
...
$id = $fila["id"];
$tipo_calle1 = $fila["tipo_calle1"];
$calle1 = $fila["calle1"];
$tipo_calle1 = $fila["tipo_calle1"];
$calle1 = $fila["calle1"];
$tipo_calle2 = $fila["tipo_calle2"];
$calle2 = $fila["calle2"];
$dia = $fila["dia"];
$mes = $fila["mes"];
$ano = $fila["ano"];
...
$sexo = $fila["sexo"];
$edad = $fila["edad"];
$cinturon = $fila["cintu_segu"];
$alcohol = $fila["ali_alcoho"];
$clima = $fila["clima"];
$luz = $fila["luz"];
$velocidad = $fila["velocidad"];
$condi_calle = $fila["condi_calle"];
$tipo_vehi1 = $fila["tipo_vehiculo1"];
$tipo_vehi2 = $fila["tipo_vehiculo2"];
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
            ...
            <div class="card-header">
              <h3 class="card-title">Modifica los campos necesarios</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div class="form-group" >
              <form action="Actualizar.php" method="get" class="form-form-group">

  <div class="form-group">
    <label>Tipo de calle 1</label>
    <select class="form-control" id="nombre" name="tipo_calle1">
      <option value="<?php echo $calle1; ?>" selected><?php echo $tipo_calle1; ?></option>
...
<input type="text" list="calle" class="form-control" name="calle1" value="<?php echo $calle1; ?>">
</div>
    <div class="form-group">
    <label>Tipo de calle 2</label>
    <select class="form-control" id="nombre" name="tipo_calle2">
      <option value="<?php echo $tipo_calle2; ?>" selected><?php echo $tipo_calle2; ?></option>
      <option value="Avenida"  >Avenida</option>
      <option value="Calle">Calle</option>
      <option value="Callejon">Callejón</option>
      <option value="Carretera">Carretera</option>
...
<input type="text" list="calle" class="form-control" name="calle2" value="<?php echo $calle2; ?>">
</div>
...
echo '<option value="' . $i . '">' . $i . '</option>';
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="nombre" name="cinturon">
      <option value="<?php echo $cinturon; ?>" selected><?php echo $cinturon; ?></option>
    ...
    <select class="form-control" id="nombre" name="alcohol">
      <option value="<?php echo $alcohol; ?>" selected><?php echo $alcohol; ?></option>
      <option value="Si" >Si</option>
      <option value="No">No</option>
      <option value="se_ignora">Se ignora</option>
    </select>
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="numero" name="clima">
      <option value="<?php echo $clima; ?>" selected><?php echo $clima; ?></option>
      ...
      <option value="Clima neutro">Clima neutro</option>
    </select>
  </div>
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="numero" name="luz">
      <option value="<?php echo $luz; ?>" selected><?php echo $luz; ?></option>
    ...
    <select class="form-control" id="nombre" name="velocidad">
      <option value="<?php echo $velocidad; ?>" selected><?php echo $velocidad; ?></option>
    ...
    <select class="form-control" id="nombre" name="condi_calle">
      <option value="<?php echo $condi_calle; ?>" selected><?php echo $condi_calle; ?></option>
    ...
    <select class="form-control" id="nombre" name="tipo_vehi2">
      <option value="<?php echo $tipo_vehi1; ?>" selected><?php echo $tipo_vehi1; ?></option>
    ...
    <select class="form-control" id="nombre" name="tipo_vehi1">
      <option value="<?php echo $tipo_vehi2; ?>" selected><?php echo $tipo_vehi2; ?></option>
      <option value="automovil" >Automóvil</option>
      <option value="camion_pasajeros">Camión de pasajeros</option>
      <option value="camioneta" >Camioneta</option>
      <option value="camion">Camión</option>
    ...
    <select class="form-control" id="nombre" name="gravedad">
      <option value="<?php echo $gravedad; ?>" selected><?php echo $gravedad; ?></option>
