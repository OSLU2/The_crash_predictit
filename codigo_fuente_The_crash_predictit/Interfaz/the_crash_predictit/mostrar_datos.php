              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               <!--   <th>Minuto</th> -->
                ...
                <!-- <th>Condición de la calle</th> -->
                 <th style = "width: 9%">Tipo de vehículo</th>
...
$consulta_contar = "SELECT COUNT(*) as total_registro FROM acci_usu";
...
$consulta = "SELECT * FROM acci_usu LIMIT $desde,$por_pagina"; 
...
echo "</tr>";
     ...
     ?>
              ...
              <input  onclick="reload" type="submit" name="borrar" value="eliminar registrsos"  class="btn btn-danger" style="margin-top: 5px;" />
              </form>
                <?php
                  if ($total_registro != 0) 
                  {
